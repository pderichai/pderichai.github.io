...
made them easier to access through better keybindings. I also customized my
color scheme and status bar and made several quality of life improvements.
...
- Detaching/switch from a Tmux session so that you can later pick up where you
